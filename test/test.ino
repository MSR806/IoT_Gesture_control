...
const int trigPin2 = 11; // the number of the trigger output pin ( sensor 1 )
const int echoPin2 = 10; // the number of the echo input pin ( sensor 1 )     
const int trigPin1 = 6;  // the number of the trigger output pin ( sensor 2 ) 
const int echoPin1 = 5;  // the number of the echo input pin ( sensor 2 ) 
